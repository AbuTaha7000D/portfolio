...
(function () {
	...
	const translations = {
		en: {
			...
			"training-google-date": "Dec 2025 – Feb 2026",
			"training-google-summary": "Professional certification covering core IT support tasks including troubleshooting, customer service, networking, operating systems, system administration, and security.",
			"training-ibm-name": "IBM Full Stack Software Developer Professional Certificate",
			"training-ibm-date": "Dec 2025 – Feb 2026",
			"training-ibm-summary": "Comprehensive training in full-stack development, cloud-native applications, and software engineering principles using modern frameworks and tools.",
			"certifications-title": "Certifications",
			"cert-filter-all": "All",
			"cert-filter-professional": "Professional",
			"cert-filter-it": "IT",
			"cert-filter-software": "Software",
			"cert-filter-business": "Business",
			"cert-view-btn": "View Certificate",
			"cert-view-badge": "View Badge",
			"cert-ibm-inst": "IBM",
			"cert-coursera-inst": "Coursera",
			"cert-ibm-fullstack": "IBM Full Stack Software Developer Professional Certificate",
			"cert-ibm-fullstack-desc": "Comprehensive training in full-stack development, cloud-native apps, and software engineering principles.",
			"cert-google-it": "Google IT Support Professional Certificate",
			"cert-google-it-desc": "Professional certification covering core IT support tasks including troubleshooting and networking.",
			"cert-google-support": "Technical Support Fundamentals",
			"cert-google-support-desc": "Key concepts of technical support, including troubleshooting and customer service.",
			"cert-google-net": "The Bits and Bytes of Computer Networking",
			"cert-google-net-desc": "Foundations of networking, including the TCP/IP model and protocols.",
			"cert-google-os": "Operating Systems and You: Becoming a Power User",
			"cert-google-os-desc": "Fundamentals of operating systems and managing computer hardware.",
			"cert-google-sysadmin": "System Administration and IT Infrastructure Services",
			"cert-google-sysadmin-desc": "Managing entire fleets of computers and server infrastructure.",
			"cert-google-security": "IT Security: Defense against the digital dark arts",
			"cert-google-security-desc": "Security principles including encryption, authentication, and network security.",
			"cert-google-ai-job": "Accelerate Your Job Search with AI",
			"cert-google-ai-job-desc": "Using generative AI tools to optimize job applications and career growth.",
			"cert-iti-cyber": "Cybersecurity Internship – ITI",
			"cert-iti-cyber-desc": "Practical training in cybersecurity fundamentals and threat analysis.",
			"cert-mahara-hacking": "Ethical Hacking – MaharaTech",
			"cert-mahara-hacking-desc": "Techniques for identifying and addressing security vulnerabilities ethically.",
			"cert-mahara-net": "Computer Network Fundamentals – MaharaTech",
			"cert-mahara-net-desc": "Networking basics including OSI model and network hardware.",
			...
			"cert-ibm-html-css-js": "Introduction to HTML, CSS, & JavaScript",
			"cert-ibm-html-css-js-desc": "Foundational skills for web development using HTML, CSS, and basic JavaScript.",
			...
			"cert-ibm-git-desc": "Essential skills for version control and collaborative development.",
			"cert-ibm-react": "Developing Front-End Apps with React",
			"cert-ibm-react-desc": "Building dynamic user interfaces using the React framework and hooks.",
			"cert-ibm-node": "Developing Back-End Apps with Node.js and Express",
			"cert-ibm-node-desc": "Creating server-side applications and RESTful APIs using Node.js.",
			"cert-ibm-python-ds": "Python for Data Science, AI & Development",
			"cert-ibm-python-ds-desc": "Introduction to Python programming for data analysis and AI.",
			"cert-ibm-ai-python": "Developing AI Applications with Python and Flask",
			"cert-ibm-ai-python-desc": "Building and deploying AI-powered web applications using Flask.",
			"cert-ibm-django": "Django Application Development with SQL and Databases",
			"cert-ibm-django-desc": "Web application development using Django, SQL, and database integration.",
			"cert-ibm-containers": "Introduction to Containers w/ Docker, Kubernetes & OpenShift",
			"cert-ibm-containers-desc": "Core concepts of containerization and orchestration using Docker and K8s.",
			"cert-ibm-microservices": "Application Development using Microservices and Serverless",
			"cert-ibm-microservices-desc": "Architecting modern applications using microservices and serverless models.",
			"cert-ibm-capstone": "Full Stack Application Development Capstone Project",
			"cert-ibm-capstone-desc": "Applying full-stack skills to build and deploy a real-world application.",
			"cert-ibm-assessment": "Full Stack Software Developer Assessment",
			"cert-ibm-assessment-desc": "Final evaluation of full-stack software development proficiencies.",
			"cert-ibm-genai": "Generative AI: Elevate your Software Development Career",
			"cert-ibm-genai-desc": "Leveraging GenAI tools to enhance productivity and code quality.",
			"cert-ibm-career": "Software Developer Career Guide and Interview Preparation",
			"cert-ibm-career-desc": "Preparation for technical interviews and career growth strategies.",
			"cert-ibm-agility": "Delivering Quality Work with Agility",
			"cert-ibm-agility-desc": "Principles of Agile methodology and delivering high-quality work.",
			"cert-excel": "Microsoft Excel",
			"cert-excel-desc": "Comprehensive Excel skills for data management and analysis.",
			...
			"cert-mahara-cloud-desc": "Core concepts of virtualization technologies and cloud deployment.",
		...
		ar: {
			...
			"training-google-date": "ديسمبر 2025 – فبراير 2026",
			"training-google-summary": "شهادة احترافية تغطي مهام الدعم الفني الأساسية بما في ذلك حل المشكلات وخدمة العملاء والشبكات وأنظمة التشغيل وإدارة النظم والأمن.",
			"training-ibm-name": "شهادة IBM الاحترافية لمطور البرمجيات Full Stack",
			"training-ibm-date": "ديسمبر 2025 – فبراير 2026",
			"training-ibm-summary": "تدريب شامل على تطوير تطبيقات Full Stack والتطبيقات السحابية ومبادئ هندسة البرمجيات باستخدام أحدث الأطر والأدوات.",
			...
			"cert-filter-business": "الأعمال",
			"cert-view-btn": "عرض الشهادة",
			"cert-view-badge": "عرض الشارة",
			"cert-ibm-inst": "IBM",
			"cert-coursera-inst": "Coursera",
			"cert-ibm-fullstack": "شهادة IBM الاحترافية لمطور البرمجيات Full Stack",
			"cert-ibm-fullstack-desc": "تدريب شامل على تطوير تطبيقات Full Stack والتطبيقات السحابية.",
			"cert-google-it": "شهادة جوجل الاحترافية في الدعم الفني (Google IT Support)",
			"cert-google-it-desc": "شهادة احترافية تغطي مهام الدعم الفني والشبكات والأمن.",
			"cert-google-support": "أساسيات الدعم الفني",
			"cert-google-support-desc": "المفاهيم الأساسية للدعم الفني بما في ذلك استكشاف الأخطاء وخدمة العملاء.",
			"cert-google-net": "أساسيات شبكات الكمبيوتر",
			"cert-google-net-desc": "أساسيات الشبكات بما في ذلك نموذج TCP/IP والبروتوكولات.",
			"cert-google-os": "أنظمة التشغيل وأنت: أن تصبح مستخدماً متميزاً",
			"cert-google-os-desc": "أساسيات أنظمة التشغيل وإدارة أجهزة الكمبيوتر.",
			"cert-google-sysadmin": "إدارة النظم وخدمات البنية التحتية لتكنولوجيا المعلومات",
			"cert-google-sysadmin-desc": "إدارة أجهزة الكمبيوتر وخدمات البنية التحتية للخوادم.",
			"cert-google-security": "أمن تكنولوجيا المعلومات: الدفاع ضد الفنون الرقمية المظلمة",
			"cert-google-security-desc": "مبادئ الأمن بما في ذلك التشفير والمصادقة وأمن الشبكات.",
			"cert-google-ai-job": "تسريع البحث عن وظيفة باستخدام الذكاء الاصطناعي",
			"cert-google-ai-job-desc": "استخدام أدوات الذكاء الاصطناعي لتحسين طلبات التوظيف والنمو المهني.",
			"cert-iti-cyber": "تدريب الأمن السيبراني – ITI",
			"cert-iti-cyber-desc": "تدريب عملي على أساسيات الأمن السيبراني وتحليل التهديدات.",
			"cert-mahara-hacking": "الاختراق الأخلاقي – MaharaTech",
			"cert-mahara-hacking-desc": "تقنيات تحديد الثغرات الأمنية ومعالجتها بطرق أخلاقية.",
			"cert-mahara-net": "أساسيات شبكات الحاسب – MaharaTech",
			"cert-mahara-net-desc": "أساسيات الشبكات بما في ذلك نموذج OSI وأجهزة الشبكات.",
			"cert-ibm-software": "مقدمة في هندسة البرمجيات",
			"cert-ibm-software-desc": "نظرة عامة على مبادئ هندسة البرمجيات ومنهجيات الأجايل.",
			"cert-ibm-cloud": "مقدمة في الحوسبة السحابية",
			"cert-ibm-cloud-desc": "المفاهيم الأساسية للحوسبة السحابية ونماذج الخدمات.",
			"cert-ibm-html-css-js": "مقدمة في HTML و CSS و JavaScript",
			"cert-ibm-html-css-js-desc": "المهارات الأساسية لتطوير الويب باستخدام HTML و CSS و JavaScript.",
			"cert-ibm-webdev": "مقدمة في تطوير الويب باستخدام HTML و CSS و JavaScript",
			"cert-ibm-webdev-desc": "المفاهيم الأساسية لتطوير الويب بما في ذلك HTML5 و CSS3.",
			"cert-ibm-git": "بداية العمل مع Git و GitHub",
			"cert-ibm-git-desc": "المهارات الأساسية للتحكم في الإصدار والتطوير التعاوني.",
			"cert-ibm-react": "تطوير تطبيقات الواجهة الأمامية باستخدام React",
			"cert-ibm-react-desc": "بناء واجهات مستخدم ديناميكية باستخدام React.",
			"cert-ibm-node": "تطوير تطبيقات الواجهة الخلفية باستخدام Node.js و Express",
			"cert-ibm-node-desc": "بناء تطبيقات الخادم وواجهات البرمجة باستخدام Node.js.",
			"cert-ibm-python-ds": "بايثون لعلوم البيانات والذكاء الاصطناعي والتطوير",
			"cert-ibm-python-ds-desc": "مقدمة لبرمجة بايثون لعلوم البيانات والذكاء الاصطناعي.",
			"cert-ibm-ai-python": "تطوير تطبيقات الذكاء الاصطناعي باستخدام بايثون وفلاسك",
			"cert-ibm-ai-python-desc": "بناء ونشر تطبيقات مدعومة بالذكاء الاصطناعي باستخدام فلاسك.",
			"cert-ibm-django": "تطوير تطبيقات Django مع SQL وقواعد البيانات",
			"cert-ibm-django-desc": "تطوير تطبيقات ويب باستخدام Django وقواعد البيانات.",
			"cert-ibm-containers": "مقدمة في الحاويات باستخدام Docker و Kubernetes و OpenShift",
			"cert-ibm-containers-desc": "المفاهيم الأساسية للحاويات والأوركسترا باستخدام Docker و K8s.",
			"cert-ibm-microservices": "تطوير التطبيقات باستخدام الخدمات المصغرة والحوسبة بدون خادم",
			"cert-ibm-microservices-desc": "معمارية التطبيقات الحديثة باستخدام الخدمات المصغرة.",
			"cert-ibm-capstone": "مشروع تخرج تطوير تطبيقات Full Stack",
			"cert-ibm-capstone-desc": "تطبيق مهارات الـ Full Stack لبناء ونشر تطبيق متكامل.",
			"cert-ibm-assessment": "تقييم مطور برمجيات Full Stack",
			"cert-ibm-assessment-desc": "التقييم النهائي لمهارات تطوير البرمجيات المتكاملة.",
			"cert-ibm-genai": "الذكاء الاصطناعي التوليدي: ارتقِ بمسيرتك المهنية في تطوير البرمجيات",
			"cert-ibm-genai-desc": "استخدام أدوات الذكاء الاصطناعي لزيادة الإنتاجية وجودة الكود.",
			"cert-ibm-career": "دليل المسار المهني لمطور البرمجيات والاستعداد للمقابلة",
			"cert-ibm-career-desc": "الاستعداد للمقابلات التقنية واستراتيجيات النمو المهني.",
			"cert-ibm-agility": "تقديم عمل عالي الجودة بمرونة (Agility)",
			"cert-ibm-agility-desc": "مبادئ منهجية الأجايل وتقنيات تقديم عمل عالي الجودة.",
			"cert-excel": "مايكروسوفت إكسل",
			"cert-excel-desc": "مهارات إكسل شاملة لإدارة البيانات وتحليلها.",
			...
			"cert-mahara-cloud-desc": "المفاهيم الأساسية لتقنيات المحاكاة الافتراضية والسحابية.",
